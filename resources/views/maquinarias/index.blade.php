                    ...
                    <div class="card mb-4 mx-4">
                        <div class="card-header pb-0">
                            <div class="d-flex flex-row justify-content-between">
                                ...
                                <a href="{{ route('maquinarias.create') }}" class="btn bg-gradient-primary btn-sm mb-0"
                                    type="button">+&nbsp; Nuevo
                                    Maquinaria</a>
                            </div>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2 mt-4">
                            <div class="table-responsive p-3">
                                <table id="maquinarias" class="table table-striped align-items-center mb-0">
                                    <thead>
                                        <tr>
                                        ...
                                        @else
                                            @foreach ($maquinarias as $maquinaria)
                                                <tr>
                                                    ...
                                                    <td class="d-flex">
                                                        <a href="{{ route('maquinarias.edit', $maquinaria->id) }}"
                                                            class="mx-3 btn btn-dark" type="button">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <form action="{{ route('maquinarias.destroy', $maquinaria->id) }}"
