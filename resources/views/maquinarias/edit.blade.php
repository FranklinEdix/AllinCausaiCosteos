                    ...
                    <div class="card mb-4 mx-4">
                        <div class="card-header pb-0">
                            <div class="d-flex flex-row justify-content-between">
                                <div>
                                    <h5 class="mb-0">Editar maquinaria</h5>
                                </div>
                            </div>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2">
                            <form action="{{ route('maquinarias.update', $maquinaria->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-12 p-4">
                                        ...
                                        <input type="text" name="nombre" class="form-control"
                                            value="{{ $maquinaria->nombre }}" required>
                                        @error('nombre')
                                        ...
                                        <input type="number" name="precio_consumo_hora" class="form-control"
                                            value="{{ $maquinaria->precio_consumo_hora }}" step="0.001" required>
