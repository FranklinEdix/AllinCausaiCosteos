                    ...
                    <div class="card mb-4 mx-4">
                        <div class="card-header pb-0">
                            <div class="d-flex flex-row justify-content-between">
                                <div>
                                    <h5 class="mb-0">Administrar Areas de La Empresa</h5>
                                </div>
                                <a href="{{ route('areas.create') }}" class="btn bg-gradient-primary btn-sm mb-0"
                                    type="button">+&nbsp; Nueva
                                    Area</a>
                            </div>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2 mt-4">
                            <div class="table-responsive p-3">
                                <table id="areas" class="table table-striped align-items-center mb-0">
                                    <thead>
                                        <tr>
                                        ...
                                        @if (empty($areas))
                                            <tr>
                                                <td colspan="5" class="text-center">
                                                    <h4>No hay areas registrados</h4>
                                                </td>
                                            </tr>
                                        @else
                                            @foreach ($areas as $area)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <p class="text-xs font-weight-bold mb-0">{{ $area->name }}
                                                        </p>
                                                    </td>
                                                    <td class="d-flex">
