                    ...
                    <div class="card mb-4 mx-4">
                        <div class="card-header pb-0">
                            <div class="d-flex flex-row justify-content-between">
                                <div>
                                    <h5 class="mb-0">Administrar Almacenes</h5>
                                </div>
                                <a href="{{ route('almacen.create') }}" class="btn bg-gradient-primary btn-sm mb-0"
                                    type="button">+&nbsp; Nuevo
                                    Almacen</a>
                            </div>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2 mt-4">
                            <div class="table-responsive p-3">
                                <table id="almacen" class="table table-striped align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            @foreach ($almacenes as $almacen)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <p class="text-xs font-weight-bold mb-0">{{ $almacen->name }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p class="text-xs font-weight-bold mb-0">
                                                            {{ $almacen->descripcion }}</p>
                                                    </td>
                                                    <td class="d-flex">
