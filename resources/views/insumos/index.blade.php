                    ...
                    <div class="card mb-4 mx-4">
                        <div class="card-header pb-0">
                            <div class="d-flex flex-row justify-content-between">
                                <div>
                                    <h5 class="mb-0">Administrar Insumos</h5>
                                </div>
                                <a href="{{ route('insumos.create') }}" class="btn bg-gradient-primary btn-sm mb-0"
                                    type="button">+&nbsp; Nuevo
                                    Insumo</a>
                            </div>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2 mt-4">
                            <div class="table-responsive p-3">
                                <table id="insumos" class="table table-striped align-items-center mb-0">
                                    <thead>
                                        <tr>
                                        ...
                                        @if (empty($insumos))
                                            <tr>
                                                <td colspan="5" class="text-center">
                                                    <h4>No hay insumos registradas</h4>
                                                </td>
                                            </tr>
                                        @else
                                            @foreach ($insumos as $insumo)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <p class="text-xs font-weight-bold mb-0">{{ $insumo->name }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p class="text-xs font-weight-bold mb-0">
                                                            {{ $insumo->presentacion }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p class="text-xs font-weight-bold mb-0">
                                                            {{ $insumo->precio_presentacion }}</p>
                                                    </td>
                                                    <td class="d-flex">
